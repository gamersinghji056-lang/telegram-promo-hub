...
export function MiniAppShell({ active, children }: { active: string; children: ReactNode }) {
  return (
    <div
      ...
      style={{ paddingBottom: "calc(6rem + var(--miniapp-keyboard-inset, 0px))" }}
    >
      ...
      <nav
        className="fixed inset-x-0 z-30 border-t border-border bg-card"
        style={{ bottom: "var(--miniapp-keyboard-inset, 0px)" }}
      >
